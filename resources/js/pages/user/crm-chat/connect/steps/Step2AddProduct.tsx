...
export default function Step2AddProduct({ data, updateData, onNext, onBack }: Props) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-xl font-semibold">Langkah 2: Tambahkan Product WhatsApp</h2>
                <p className="text-gray-500 text-sm mt-1">
                    Aktifkan WhatsApp Business di aplikasi Meta Anda
                </p>
            </div>

            <div className="bg-gray-50 border rounded-lg p-5 space-y-3">
                <h3 className="font-semibold text-sm text-gray-700">Cara Menambahkan Product WhatsApp:</h3>
                <ol className="space-y-3 text-sm text-gray-600">
                    ...
                    <li className="flex gap-2">
                        ...
                        <span>Cari <strong>WhatsApp</strong> lalu klik <strong>Set up</strong></span>
                    </li>
                    <li className="flex gap-2">
                        <span className="font-bold text-blue-500 min-w-[20px]">4.</span>
                        <span>Menu <strong>WhatsApp</strong> akan muncul di sidebar kiri</span>
                    </li>
                    <li className="flex gap-2">
                        <span className="font-bold text-blue-500 min-w-[20px]">5.</span>
                        <span>Klik <strong>WhatsApp</strong> di sidebar, lalu pilih <strong>API Setup</strong></span>
                    </li>
                </ol>
            </div>
            ...
            <div className="border-t pt-5 space-y-3">
                ...
                <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                    <input
                        ...
                        className="w-4 h-4"
                    />
                    <span className="text-sm">Product WhatsApp sudah ditambahkan ke aplikasi</span>
                </label>
                ...
                <label className="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                    <input
                        ...
                        className="w-4 h-4"
                    />
                    <span className="text-sm">Menu WhatsApp sudah muncul di sidebar kiri</span>
                </label>
            </div>

...
export default function Step3SetupWebhook({ data, updateData, onNext, onBack, webhookUrl, verifyToken }: Props) {
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 text-sm mt-1">
                    Webhook diperlukan agar ChatCepat dapat menerima pesan masuk dari WhatsApp
                </p>
            </div>

            <div className="bg-gray-50 border rounded-lg p-5 space-y-3">
                <h3 className="font-semibold text-sm text-gray-700">Cara Setup Webhook:</h3>
                <ol className="space-y-2 text-sm text-gray-600">
                    <li className="flex gap-2">
                        <span className="font-bold text-blue-500 min-w-[20px]">1.</span>
                        <span>Di Meta Developer Console, klik <strong>WhatsApp</strong> lalu <strong>Configuration</strong></span>
                    </li>
                    <li className="flex gap-2">
            ...
            <div className="space-y-3 p-5 bg-green-50 border border-green-200 rounded-lg">
                <h3 className="font-semibold text-sm text-green-800">Data Webhook (copy ke Meta Developer Console):</h3>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                <p>
                    <strong>Info:</strong> Jika webhook verification berhasil, akan muncul notifikasi success di Meta. Field "messages" wajib di-subscribe agar pesan masuk bisa diterima oleh ChatCepat.
                </p>
            </div>

...
export default function Step3SetupWebhookMessenger({ data, updateData, onNext, onBack, webhookUrl, verifyToken }: Props) {
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 text-sm mt-1">
                    Webhook diperlukan agar ChatCepat dapat menerima pesan masuk dari Facebook Messenger
                </p>
            </div>

            <div className="bg-gray-50 border rounded-lg p-5 space-y-3">
                <h3 className="font-semibold text-sm text-gray-700">Cara Setup Webhook Messenger:</h3>
                <ol className="space-y-2 text-sm text-gray-600">
                    <li className="flex gap-2">
                        <span className="font-bold text-blue-500 min-w-[20px]">1.</span>
                        <span>Di Meta Developer Console, klik <strong>Messenger</strong> lalu <strong>Configuration</strong></span>
                    </li>
                    <li className="flex gap-2">
            ...
            <div className="space-y-3 p-5 bg-blue-50 border border-blue-200 rounded-lg">
                <h3 className="font-semibold text-sm text-blue-800">Data Webhook (copy ke Meta Developer Console):</h3>
            ...
            <div className="bg-gray-50 border rounded-lg p-5 space-y-2 text-sm text-gray-600">
                <ol className="space-y-2" start={4}>
                    ...
                    <li className="flex gap-2">
                        ...
                        <span>Aktifkan (toggle ON) field <strong>messages</strong> dan <strong>messaging_postbacks</strong> di kolom Subscribe</span>
                    </li>
                </ol>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800">
                <p>
                    <strong>Info:</strong> Untuk Messenger, pastikan Facebook Page Anda sudah terhubung ke Meta App. Subscribe minimal field <strong>messages</strong> agar pesan Messenger dapat diterima oleh ChatCepat.
                </p>
            </div>

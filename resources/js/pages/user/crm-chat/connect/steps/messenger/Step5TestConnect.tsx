...
export default function Step5TestConnectMessenger({ data, onBack, onComplete }: Props) {
    ...
    const checks = [
        ...
        { label: 'App Secret diisi', done: !!data.appSecret },
    ]
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-50 border rounded-lg p-5 space-y-4">
                ...
                <div className="border-t pt-4 space-y-1.5 text-sm">
                    ...
                    <div className="grid grid-cols-[160px,1fr] gap-2">
                        <span className="font-medium text-gray-600">App Secret</span>
                        <span className="font-mono text-xs">{data.appSecret ? '••••••••' + data.appSecret.slice(-4) : '-'}</span>
                    </div>
                </div>
            </div>

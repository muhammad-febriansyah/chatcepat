...
export default function SuccessScreenMessenger({ data }: Props) {
    return (
        <div className="flex flex-col items-center text-center py-8 space-y-6">
            ...
            <div>
                <h2 className="text-2xl font-bold text-gray-900">Facebook Messenger Berhasil Terhubung</h2>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-5 w-full text-left space-y-2">
                ...
                {[
                    ...
                    'App Secret tersimpan',
                    'Siap terima pesan Messenger',
                ].map((item, i) => (
            ...
            <div className="w-full">
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <button
                        ...
                        className="p-4 border rounded-lg hover:bg-gray-50 text-center space-y-2 transition-all"
                    >
                        <Radio className="w-6 h-6 text-pink-500 mx-auto" />
                        <p className="text-xs font-medium">Hubungkan Instagram</p>
                    </button>
                </div>
            </div>

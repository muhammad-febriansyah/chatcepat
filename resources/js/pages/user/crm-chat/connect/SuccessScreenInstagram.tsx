...
export default function SuccessScreenInstagram({ data }: Props) {
    return (
        <div className="flex flex-col items-center text-center py-8 space-y-6">
            ...
            <div>
                <h2 className="text-2xl font-bold text-gray-900">Instagram Berhasil Terhubung</h2>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-5 w-full text-left space-y-2">
                ...
                {[
                    ...
                    'Instagram Business Account ID tersimpan',
                    'Facebook Page ID tersimpan',
                    'Page Access Token tersimpan',
                    'Siap terima pesan DM Instagram',
                ].map((item, i) => (
            ...
            <div className="w-full">
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                        <MessageCircle className="w-6 h-6 text-pink-500 mx-auto" />
                    ...
                    <button
                        onClick={() => router.visit('/user/crm-chat/connect/messenger')}
                        className="p-4 border rounded-lg hover:bg-gray-50 text-center space-y-2 transition-all"
                    >
                        <Radio className="w-6 h-6 text-blue-500 mx-auto" />
                        <p className="text-xs font-medium">Hubungkan Messenger</p>
                    </button>
                </div>
            </div>
            ...
            <div className="flex gap-3 w-full">
                <Button
                    variant="outline"
                    className="flex-1"
                    onClick={() => router.visit('/user/crm-chat/connect/instagram')}
                >
                    Tambah Channel Lain
                </Button>
                <Button

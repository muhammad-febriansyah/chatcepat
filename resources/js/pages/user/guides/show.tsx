...
interface UserGuideCategoryWithArticles extends GuideCategory {
...
interface UserGuideShowProps {
    ...
    allCategories: UserGuideCategoryWithArticles[]
}
...
export default function UserGuideShow({ article, allCategories }: UserGuideShowProps) {

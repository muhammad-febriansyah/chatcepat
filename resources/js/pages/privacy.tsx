...
export default function Privacy({ page, canRegister = true }: PrivacyProps) {
    if (!page) {
        return (
            <HomeLayout title="Kebijakan Privasi" canRegister={canRegister}>
                <PageHeader
    ...
    return (
        ...
        >
            <PageHeader
                title={page.title}
                description={
                    page.excerpt || 'Bagaimana kami mengumpulkan, menggunakan, dan melindungi data pribadi Anda'
                }
                breadcrumbs={[
                    { name: 'Home', href: '/' },
                    { name: page.title },

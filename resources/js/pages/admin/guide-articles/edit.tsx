...
interface EditGuideArticleProps {
    article: GuideArticle
    categories: GuideCategory[]
}

export default function EditGuideArticle({ article, categories }: EditGuideArticleProps) {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        post(`/admin/guides/articles/${article.id}`, {
            forceFormData: true,
        })
    }
    ...
    return (
        <AdminLayout>
            <Head title="Edit Artikel Panduan" />

            <PageHeader
                title="Edit Artikel"
                description={`Edit artikel: ${article.title}`}
            />
                    ...
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>Perbarui detail artikel</CardDescription>
                            </div>
                        </div>
                    </CardHeader>

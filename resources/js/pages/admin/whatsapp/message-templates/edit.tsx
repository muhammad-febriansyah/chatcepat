...
export default function MessageTemplateEdit({ template }: Props) {
  ...
  const handleSubmit: FormEventHandler = (e) => {
    e.preventDefault();
    put(`/admin/whatsapp/message-templates/${template.id}`);
  };

  return (
    <AdminLayout>
      <Head title="Edit Template Pesan" />
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Edit Template Pesan</h1>
            <p className="text-gray-600 mt-1">
              Perbarui template pesan WhatsApp
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Perbarui informasi template pesan WhatsApp
              </CardDescription>
            </CardHeader>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-semibold">{template.usage_count || 0}x</p>
                  </div>
                  <div>
                    <p className="text-gray-600">Status:</p>
                    <p className="font-semibold">{template.is_active ? 'Aktif' : 'Nonaktif'}</p>
                  </div>
                </div>
              </div>
            </CardContent>

...
export default function Create() {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        e.preventDefault()
        post('/admin/scraper-categories')
    }

    return (
        <AdminLayout>
            <Head title="Tambah Kategori Scraper" />

            <PageHeader
                title="Tambah Kategori Scraper"
                description="Buat kategori baru dengan icon marker kustom"
            >
                ...
                <div className="md:col-span-2">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Masukkan detail kategori scraper
                            </CardDescription>
                        </CardHeader>
                        <CardContent>

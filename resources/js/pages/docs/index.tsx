...
export default function DocsIndex({ categories, search }: DocsIndexProps) {
    return (
        <>
            <Head title="Dokumentasi - ChatCepat" />
            <GuideLayout
                title="Dokumentasi ChatCepat"
                            ...
                            {category.articles.length > 0 ? (
                                <div className="grid gap-4 sm:gap-5 md:grid-cols-2">
                                    {category.articles.map((article) => (
                                        <Link
                                            key={article.id}
                                            href={route('docs.show', article.slug)}

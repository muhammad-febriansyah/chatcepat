...
export const AnimatedShinyText: FC<AnimatedShinyTextProps> = ({
  ...
  return (
    <span
      ...
      className={cn(
        "mx-auto max-w-md text-black dark:text-neutral-400/70",
        ...
        // Shine gradient - changed to black
        "bg-gradient-to-r from-black/100 via-black/100 via-50% to-black/100 dark:via-white/80",
